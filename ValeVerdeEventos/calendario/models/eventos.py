...
from calendario.models import t_cliente, t_fornecedor
...
class t_evento(models.Model):
    ...
    servicos = models.CharField(max_length=40, checkbox=opcao_servico, default='',
        verbose_name='Opções de Serviço')
    descricao = models.TextField(blank=True, verbose_name='Descrições Extra')
    valor = models.DecimalField(max_digits=8, decimal_places=2, localize=True,
        blank=False, verbose_name='Valor Total do Evento')
    ...
    data_hora = models.SlugField(unique_for_date='data', USE_TZ="True")
    fk_Cliente = models.ForeignKey(t_cliente, on_delete=models.PROTECT, default='',
        verbose_name='Cliente')
    fk_Fornecedor = models.ManyToManyField(t_fornecedor, blank=False,
